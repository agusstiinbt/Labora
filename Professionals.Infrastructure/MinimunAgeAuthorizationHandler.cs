...
{
    /// <summary>
    /// Decide SI el usuario cumple una regla de autorizacion basada en la edad minima requerida.
    /// </summary>
    /// <param name="logger"></param>
    public class MinimumAgeAuthorizationHandler(ILogger<MinimumAgeAuthorizationHandler> logger)
